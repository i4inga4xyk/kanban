import { Controller, Get, Post, Body, Param, Delete, UsePipes, ValidationPipe, UseGuards, Req, Query } from '@nestjs/common';
...
export class StatusController {
  ...
  @ApiCreatedResponse({description: "Status successfully created!", type: Status})
  ...
  @ApiOperation({description: "Deletes a status from the project; available only for the owner of the project"})
  @ApiParam({name: "id", description: "Status ID"})
