...
export class ProjectsController {
  ...
  @ApiOperation({
    description:
      'Returns a project by its id, if current user is linked to it.',
  })
  ...
  @ApiOperation({
    description:
      'Updates project data; only accessible to the owner of the project',
  })
  @ApiParam({ name: 'id', description: 'Project ID' })
  ...
  @ApiOperation({
    description:
      'Deletes a project by id; only accessible to the owner of the project.',
  })
  @ApiParam({ name: 'id', description: 'Project ID' })
